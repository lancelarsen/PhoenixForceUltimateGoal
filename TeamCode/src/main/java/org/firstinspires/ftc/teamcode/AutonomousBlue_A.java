...
@Autonomous(name="(BLUE) A [Full->*P1(Wall)] GYRO", group="Blue")
public class AutonomousBlue_A_Gyro extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Strategy Details ---
    ...
    public void runOpMode() 
    {
        ...
        ShowMessage("(BLUE) A [Full->*P1(Wall)] GYRO");
