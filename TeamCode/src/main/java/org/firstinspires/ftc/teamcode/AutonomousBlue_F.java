...
@Disabled
@Autonomous(name="(BLUE) F [Foundation->P1(Wall)]", group="Blue")
public class AutonomousBlue_F extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Strategy Details ---
    ...
    public void runOpMode() 
    {
        ...
        ShowMessage("(BLUE) F [Foundation->P1]");
        ...
        StrafeLeft(1,25,5);                     //--- *** Strafe against wall 
        SmartSleep(5000);
