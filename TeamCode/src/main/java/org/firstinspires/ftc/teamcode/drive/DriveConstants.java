...
public class DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 1.88976; // in (was 1.88976)
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed (was 1)
    public static double TRACK_WIDTH = 40; // in -- (was 12.8) (15.1 for 90)
