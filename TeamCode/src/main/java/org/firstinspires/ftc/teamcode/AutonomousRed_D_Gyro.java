...
@Disabled
@Autonomous(name="(RED) D [Full->*P2(Center)] GYRO", group="Red")
public class AutonomousRed_D_Gyro extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Strategy Details ---
    ...
    public void runOpMode() 
    {
        ...
        ShowMessage("(RED) D [Full->*P2(Center)] GYRO");
