...
@Disabled
@Autonomous(name="(BLUE) D [Full->P2(Center)]", group="Blue")
public class AutonomousBlue_D extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Strategy Details ---
    ...
    public void runOpMode() 
    {
        ...
        Strafe135(-1);                          //--- *** Strafe backwards 135 degrees (aligning with P2)
        SmartSleep(750);                        //--- *** ...for 0.75 seconds
        LifterToPosition(0);                    //--- Lower Arm before Parking
        EncoderDrive(1,-12,-12,99);             //--- *** Move Back to Park
        LifterToPosition(0);                    //--- Lower Arm before Parking
