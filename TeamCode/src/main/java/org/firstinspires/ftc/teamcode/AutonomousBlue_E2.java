...
public class AutonomousBlue_E2 extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Autonomous Code
    //----------------------------------------------------------------------
    ...
    public void runOpMode() 
    {
        ...
        EncoderDriveAccel(0.8,-10,-10,3,10);      //--- Move back to give space for turn
        ...
        SmartSleep(1000);                       //--- ...for 1 second
        BrickIntakeStop();                      //--- Intake Servos Stop
        StrafeRight(1,8,99);
        LifterToPosition(0);                    //--- Lower Lifter to ground
        SmartSleep(2000);                       //--- ...for 1 second

        if (skystoneNumber == 1)
        {
            StrafeRight(1,80,99);               //--- *** Align with Skystone 1
        }
        else if (skystoneNumber == 2)
        {
            StrafeRight(1,90,99);               //--- *** Align with Skystone 2
        }
        else if (skystoneNumber == 3)
        {
            StrafeRight(1,90,99);               //--- *** Align with Skystone 3
        }

        LifterToPosition(600);                  //--- Raise Lifter
        */
        SpacerDown();                           //--- Brick spacer down 
        SmartSleep(500);                       //--- ...for 1 second
        EncoderDriveAccelToDistanceShort(1, 6, 6, 3, 3, 25);    //--- Stop at ~15cm from stones 
