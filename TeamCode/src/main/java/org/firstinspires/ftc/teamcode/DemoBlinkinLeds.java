...
@Disabled
@TeleOp(name="Test: BlinkinExample", group = "Demo")
//@Disabled
public class DemoBlinkinLeds extends OpMode {
    ...
    public void init()
    {
        ...
        blinkinLedDriver = hardwareMap.get(RevBlinkinLedDriver.class, "blinkin1");
