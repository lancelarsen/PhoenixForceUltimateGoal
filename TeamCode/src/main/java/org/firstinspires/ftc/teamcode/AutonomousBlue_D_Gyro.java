...
@Disabled
@Autonomous(name="(BLUE) D [Full->*P2(Center)] GYRO", group="Blue")
public class AutonomousBlue_D_Gyro extends PhoenixBotSharedCode
{
    //----------------------------------------------------------------------
    //--- Strategy Details ---
    ...
    public void runOpMode() 
    {
        ...
        Strafe135(-1);                          //--- *** Strafe backwards with the foundation away from wall
        SmartSleep(1000);                       //--- ...for seconds
        
        EncoderDrive(1,-40,-40);                //--- Drag foundation backwards
        ...
        GyroTurn(1, -60, 5000);                 //--- *** Turn towards bridge
